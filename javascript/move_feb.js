...
$(function(){
  ...
  $.ajax({url: 'data_move_feb.json', dataType: 'json', async: false}).done(function(data){
  ...
  $('#order-btn').click(function(){
    ...
    //   var x = i - 1;
    //   from_new_number[x] = position[x][order_value];
    // }
    // for(var i = 1; i < position.length; i++){
    //   var x = i - 1;
    //   to_new_number[i] = position[order_value][x];
    // }
    //
    //
    ...
    // for(var i = 1; i < position.length; i++){
    //   $('#' + i + "-1").prev('td').text(from_new_position[i]);
    //   $('#' + i + "-1").text(from_new_number[i] + '人');
    //   $('#' + i + "-2").prev('td').text(to_new_position[i]);
    //   $('#' + i + "-2").text(to_new_number[i] + '人');
    // }
