$(function(){
  ...
  for(var i = 0; i < position_all.length; i++){
    for(var j = 0; j < position_all[i].length; j++){
      position_all[i][j] = position_2016_october[i][j] + position_2016_november[i][j] + position_2016_december[i][j] + position_2017_january[i][j] + position_feb[i][j] + position_march[i][j] + position_april[i][j] + position_may[i][j] + position_june[i][j] + position_2017_july[i][j] + position_2017_august[i][j];
    }
  }
  ...
  $('#order_btn').click(function(){
    ...
    if (order_month_value == 3) {
      ...
      for(var i = 1; i < position_2016_november.length; i++){
        from_new_number[i - 1] = position_2016_november[i][order_position_value];
      }

      for(var i = 1; i < position_2016_november.length; i++){
        to_new_number[i - 1] = position_2016_november[order_position_value][i];
      }

      for(var i = 0; i < position_2016_november.length - 1; i++){
        for(var j = position_2016_november.length - 1; i < j; j--){
          if(from_new_number[j] > from_new_number[j - 1]){
            var temp;
      ...
      $('#central-position').text(order_text);
      $('.caption').text("2016/11月の観光者の移動動態");
    ...
    if (order_month_value == 4) {
      ...
      for(var i = 1; i < position_2016_december.length; i++){
        from_new_number[i - 1] = position_2016_december[i][order_position_value];
      }

      for(var i = 1; i < position_2016_december.length; i++){
        to_new_number[i - 1] = position_2016_december[order_position_value][i];
      }

      for(var i = 0; i < position_2016_december.length - 1; i++){
        for(var j = position_2016_december.length - 1; i < j; j--){
          if(from_new_number[j] > from_new_number[j - 1]){
            var temp;
      ...
      $('#central-position').text(order_text);
      $('.caption').text("2016/12月の観光者の移動動態");
    }
    if (order_month_value == 5) {
      ...
      for(var i = 1; i < position_2017_january.length; i++){
        from_new_number[i - 1] = position_2017_january[i][order_position_value];
      }

      for(var i = 1; i < position_2017_january.length; i++){
        to_new_number[i - 1] = position_2017_january[order_position_value][i];
      }

      for(var i = 0; i < position_2017_january.length - 1; i++){
        for(var j = position_2017_january.length - 1; i < j; j--){
          if(from_new_number[j] > from_new_number[j - 1]){
            var temp;
    ...
    if (order_month_value == 6) {
      ...
      $('#central-position').text(order_text);
      $('.caption').text("2017/2月の観光者の移動動態");

      console.log(order_month_value);
      console.log(order_position_value);
    }
    if (order_month_value == 7) {
      var from_new_position = ["宇奈月温泉","氷見漁港場外市場『ひみ番屋街』","黒部峡谷鉄道","世界遺産 相倉合掌造り集落","立山黒部アルペンルート","国宝 高岡山瑞龍寺","高岡大仏","海王丸パーク","海の駅 蜃気楼","おわら資料館","ほたるいかミュージアム","富岩運河環水公園","富山城","魚津水族館","雨晴海岸","称名滝","ますのすし本舗 源 ますのすしミュージアム","庄川温泉郷","魚津埋没林博物館","いなみ木彫りの里 創遊館","大牧温泉","株式会社 池田屋安兵衛商店","魚の駅「生地」","新湊きっときと市場","瑞泉寺","YKKセンターパーク","富山県 [立山博物館]","チューリップ四季彩館","城端曳山会館","廣貫堂資料館","三井アウトレットパーク北陸小矢部","富山市ガラス美術館","新潟県","岐阜県","石川県","長野県","福井県"];
      var from_new_number = new Array(38);
      ...
      $('#central-position').text(order_text);
      $('.caption').text("2017/3月の観光者の移動動態");

      console.log(order_month_value);
      console.log(order_position_value);
    }
    if (order_month_value == 8) {
      var from_new_position = ["宇奈月温泉","氷見漁港場外市場『ひみ番屋街』","黒部峡谷鉄道","世界遺産 相倉合掌造り集落","立山黒部アルペンルート","国宝 高岡山瑞龍寺","高岡大仏","海王丸パーク","海の駅 蜃気楼","おわら資料館","ほたるいかミュージアム","富岩運河環水公園","富山城","魚津水族館","雨晴海岸","称名滝","ますのすし本舗 源 ますのすしミュージアム","庄川温泉郷","魚津埋没林博物館","いなみ木彫りの里 創遊館","大牧温泉","株式会社 池田屋安兵衛商店","魚の駅「生地」","新湊きっときと市場","瑞泉寺","YKKセンターパーク","富山県 [立山博物館]","チューリップ四季彩館","城端曳山会館","廣貫堂資料館","三井アウトレットパーク北陸小矢部","富山市ガラス美術館","新潟県","岐阜県","石川県","長野県","福井県"];
      var from_new_number = new Array(38);
      ...
      $('#central-position').text(order_text);
      $('.caption').text("2017/4月の観光者の移動動態");

      console.log(order_month_value);
      console.log(order_position_value);
    }
    if (order_month_value == 9) {
      var from_new_position = ["宇奈月温泉","氷見漁港場外市場『ひみ番屋街』","黒部峡谷鉄道","世界遺産 相倉合掌造り集落","立山黒部アルペンルート","国宝 高岡山瑞龍寺","高岡大仏","海王丸パーク","海の駅 蜃気楼","おわら資料館","ほたるいかミュージアム","富岩運河環水公園","富山城","魚津水族館","雨晴海岸","称名滝","ますのすし本舗 源 ますのすしミュージアム","庄川温泉郷","魚津埋没林博物館","いなみ木彫りの里 創遊館","大牧温泉","株式会社 池田屋安兵衛商店","魚の駅「生地」","新湊きっときと市場","瑞泉寺","YKKセンターパーク","富山県 [立山博物館]","チューリップ四季彩館","城端曳山会館","廣貫堂資料館","三井アウトレットパーク北陸小矢部","富山市ガラス美術館","新潟県","岐阜県","石川県","長野県","福井県"];
      var from_new_number = new Array(38);
      ...
      $('#central-position').text(order_text);
      $('.caption').text("2017/5月の観光者の移動動態");

      console.log(order_month_value);
      console.log(order_position_value);
    }
    if (order_month_value == 10) {
      var from_new_position = ["宇奈月温泉","氷見漁港場外市場『ひみ番屋街』","黒部峡谷鉄道","世界遺産 相倉合掌造り集落","立山黒部アルペンルート","国宝 高岡山瑞龍寺","高岡大仏","海王丸パーク","海の駅 蜃気楼","おわら資料館","ほたるいかミュージアム","富岩運河環水公園","富山城","魚津水族館","雨晴海岸","称名滝","ますのすし本舗 源 ますのすしミュージアム","庄川温泉郷","魚津埋没林博物館","いなみ木彫りの里 創遊館","大牧温泉","株式会社 池田屋安兵衛商店","魚の駅「生地」","新湊きっときと市場","瑞泉寺","YKKセンターパーク","富山県 [立山博物館]","チューリップ四季彩館","城端曳山会館","廣貫堂資料館","三井アウトレットパーク北陸小矢部","富山市ガラス美術館","新潟県","岐阜県","石川県","長野県","福井県"];
      var from_new_number = new Array(38);
      ...
      $('#central-position').text(order_text);
      $('.caption').text("2017/6月の観光者の移動動態");

      console.log(order_month_value);
      console.log(order_position_value);
    }
    if (order_month_value == 11) {
      var from_new_position = ["宇奈月温泉","氷見漁港場外市場『ひみ番屋街』","黒部峡谷鉄道","世界遺産 相倉合掌造り集落","立山黒部アルペンルート","国宝 高岡山瑞龍寺","高岡大仏","海王丸パーク","海の駅 蜃気楼","おわら資料館","ほたるいかミュージアム","富岩運河環水公園","富山城","魚津水族館","雨晴海岸","称名滝","ますのすし本舗 源 ますのすしミュージアム","庄川温泉郷","魚津埋没林博物館","いなみ木彫りの里 創遊館","大牧温泉","株式会社 池田屋安兵衛商店","魚の駅「生地」","新湊きっときと市場","瑞泉寺","YKKセンターパーク","富山県 [立山博物館]","チューリップ四季彩館","城端曳山会館","廣貫堂資料館","三井アウトレットパーク北陸小矢部","富山市ガラス美術館","新潟県","岐阜県","石川県","長野県","福井県"];
      var from_new_number = new Array(38);
      ...
      for(var i = 1; i < position_2017_july.length; i++){
        from_new_number[i - 1] = position_2017_july[i][order_position_value];
      }

      for(var i = 1; i < position_2017_july.length; i++){
        to_new_number[i - 1] = position_2017_july[order_position_value][i];
      }

      for(var i = 0; i < position_2017_july.length - 1; i++){
        for(var j = position_2017_july.length - 1; i < j; j--){
          if(from_new_number[j] > from_new_number[j - 1]){
            var temp;
      ...
      $('#central-position').text(order_text);
      $('.caption').text("2017/7月の観光者の移動動態");
    }
    if (order_month_value == 12) {
      var from_new_position = ["宇奈月温泉","氷見漁港場外市場『ひみ番屋街』","黒部峡谷鉄道","世界遺産 相倉合掌造り集落","立山黒部アルペンルート","国宝 高岡山瑞龍寺","高岡大仏","海王丸パーク","海の駅 蜃気楼","おわら資料館","ほたるいかミュージアム","富岩運河環水公園","富山城","魚津水族館","雨晴海岸","称名滝","ますのすし本舗 源 ますのすしミュージアム","庄川温泉郷","魚津埋没林博物館","いなみ木彫りの里 創遊館","大牧温泉","株式会社 池田屋安兵衛商店","魚の駅「生地」","新湊きっときと市場","瑞泉寺","YKKセンターパーク","富山県 [立山博物館]","チューリップ四季彩館","城端曳山会館","廣貫堂資料館","三井アウトレットパーク北陸小矢部","富山市ガラス美術館","新潟県","岐阜県","石川県","長野県","福井県"];
      var from_new_number = new Array(38);
      ...
      for(var i = 1; i < position_2017_august.length; i++){
        from_new_number[i - 1] = position_2017_august[i][order_position_value];
      }

      for(var i = 1; i < position_2017_august.length; i++){
        to_new_number[i - 1] = position_2017_august[order_position_value][i];
      }

      for(var i = 0; i < position_2017_august.length - 1; i++){
        for(var j = position_2017_august.length - 1; i < j; j--){
          if(from_new_number[j] > from_new_number[j - 1]){
            var temp;
